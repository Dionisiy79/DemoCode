...
main = putStr "Hello, World!"     -- Вывод строки в консоль без перевода строки
...
{-
    ...
    exp1_part1    -- Краткий синтаксис. Эквиваленто {exp1_part1 exp1_part2 exp1_part3; exp2;
      ...
      exp1_part3  -- Следующая часть выражения должна начинаться не правее предыдущей. Правее означает "{" Отступ влево до уровня начальной строки блока означает "}".  Отсутствие отступа вправо относительно п строки означает ";"
    exp2          
-}
