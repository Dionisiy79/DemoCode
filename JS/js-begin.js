...
console.groupEnd("Приведение простых типов при операциях");        
  ...
  var f01 = function() {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ  
    ...
    // Вызов функций без аргументов
        ...
        proc1b(); /* Если функция объявлена в режиме Function Expression вызов функции можно 
    ...
    /* Вызов функций с аргументами и демонстрация области видимости переменных. */
        ...
        proc4(35,45); // Функция изменила глобальную переменную str1 (плохое поведение)
        console.log("Функцией proc4 получены аргументы. " + str1);
