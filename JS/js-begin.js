...
console.groupEnd("Приведение простых типов при операциях");        
  ...
  (function() {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ  
  ...
  (function() {/* ФУНКЦИОНАЛЬНОЕ ПРОГРАММИРОВАНИЕ 
  ...
  console.groupCollapsed("Функциональное программирование");
    ...
    //   if(0) localFunc(); // Выдаст ошибку: Uncaught ReferenceError: localFunc is not defined
