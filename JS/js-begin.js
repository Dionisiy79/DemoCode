...
"use strict"; /* Эта директива переводит интерпретатор в режим современного стандарта ES5. 
...
console.groupCollapsed("Работа с функциями и процедурами");
    ...
    // Использование функций
        ...
        function proc3(width, height) { /* Можно указать имена аргументов. 
            ...
            wight = 65; var height = 75; /* Значение аргументов можно по неосторожности заменить 
    ...
    // Область видимости функциональных выражений
        ...
        f1 = f2; myFunc = null; /* Восстанавливаем переменную какой она была и пробуем теперь 
