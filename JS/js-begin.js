...
{/* КОМАНДЫ ВЗАИМОДЕЙСТВИЯ С ПОЛЬЗОВАТЕЛЕМ */
  ...
  { /* Вывод текстовых строк  
    ...
    */
        ...
        console.log('а','б','в');     // Можно вывести несколько строк, разделив их запятыми
    ...
    */
    ...
    // ПРИМИТИВНЫЕ ТИПЫ ДАННЫХ //
        ...
        // Задание целых 32-битных чисел в других системах счисления //
         ...
         // numb2 = 0o70;  // Восьмиричное число начинается с 0o - недоступно в strict-режиме
...
{/* ФУНКЦИИ */
  ...
  {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ 
    ...
    */
    ...
    // ДОСТУП КО ВСЕМ АРГУМЕТАМ, ПЕРЕДАННЫМ В ФУНКЦИЮ // 
    ...
    // ПАРАМЕТРЫ ФУНКЦИИ //
        ...
        */
        function proc4(width, height) { // Указано два параметра с именами width и height.
            ...
            /* var width = 65, height = 75; /* Значение параметров можно по неосторожности заменить 
                на другое. Компилятор ошибки не покажет (кроме старых браузеров). 
                Эту особенность можно использовать для проставления значений по умолчанию 
                (на случай, если аргумент не передан в функцию): */
        ...
        proc4(35,45); 
        proc4("Только один аргумент"); /* Если передать аргументов меньше, чем объявлено параметров, 
                       то для непереданных аргументов параметры останутся со значениями undefined */
    }
    f01(); 
