...
console.group("Хранение и обработка данных в оперативной памяти");
  ...
  */
  ...
  console.groupCollapsed("Операции");       
    ...
    //  numb1 = 2 ** -2;   // == 0.25 Отрицательная степень (сколько раз разделить единицу на число)      
        ...
        // Для вычисления корня можно использовать возведение в дробную степень либо функцию:
  ...
  console.group("Приведение простых типов при операциях");
...
console.groupEnd("Приведение простых типов при операциях");        
  ...
  function f01() {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ  
  ...
  console.groupCollapsed("Процедурное программирование");
    ...
    // Вызов функций без аргументов
        ...
        var proc2b = function(){   // Объявление функции в режиме Function Expression
            console.log('Выполняется процедура proc1b');
        }
        proc2b(); /* Если функция объявлена в режиме Function Expression вызов функции можно 
                     делать только после объявления функции */
        proc2b = null; // Переменную содержащую функциональное выражение можно обнулить
    ...
    /*  Использование аргументов, переданных в функцию. Доступ к необъявленным аргументам 
        ...
        function proc2() { // Вывод первых двух аргументов в консоль. Может не работать в Gecko
  ...
  function f02() {/* ФУНКЦИОНАЛЬНОЕ ПРОГРАММИРОВАНИЕ 
