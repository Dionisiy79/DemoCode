...
{
  {/*  ОБЩИЕ СИНТАКСИЧЕСКИЕ ТЕРМИНЫ И ПРАВИЛА
    - Инструкция - это фрагмент кода, который выпоняет действие.
    ...
    */ 
    ...
    /* В JS нет дирректив условной компиляции, поэтому отключить выполнение кода, можно либо 
       закомментировав его, либо поместив внутрь блока if(0){  } */
       if(0){ "Невыполнящийся код" } // В коде не должно быть ошибок. 
            // Для включения нужно 0 заменить на 1 или другое логическое выражение.
  }
}
  ...
  {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ 
    ...
    */
    ...
    /* Объявление функции в режиме Function Declaration допустимо в любом месте кода.
       В некоторых старых браузерах strict-режим накладывает ограничение объявлять функцию только на
       верхнем уровне кода или внутри другой функции. Т.е. объявление нельзя помещать в блок {}.
