  ...
  {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ 
    ...
    */
    ...
    // ПАРАМЕТРЫ ФУНКЦИИ //
        ...
        /* При объявлении функции можно в круглых скобкаха перечислить имена меременных, которым
           будут присвоенны значения аргументов. Такие переменные называются параметрами.
           Иными словами, в параметры сохраняются аргументы (в переменные сохраняются значения)
        */
