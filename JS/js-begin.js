    ...
    */
    ...
    // ОБЛАСТЬ ВИДИМОСТИ ПЕРЕМЕННЫХ //
        ...
        /*  В ES5 реализована только функциональная видимость переменных (в отличие от ES6, где есть
            ...
            В JavaScript реализован 3-й вид: специальное связывание с применнем замыкания (closure). 
            Тема замыканий раскрыта ниже в разделе "функциональное программирование".
            С одной стороны создание замыканий ухудшает производительность, но с другой повышает 
            надёжность программ, в частности позволяет полностью решить т.н. "проблему фунарга" (или 
            функционального аргумента - когда функция используется как аргумент  в разных других 
            функциях).
