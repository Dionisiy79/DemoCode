    ...
    */
    ...
    // ОБЪЯВЛЕНИЕ И ИНИЦИАЛИЗАЦИЯ ПЕРЕМЕННЫХ //
        ...
        /* Новая переменная объявляется с помощью ключевого слова var в любом месте кода.
           Это допустимо потому, что все объявления компилятор переносит в самое начало кода
           программы либо в самое начало функции, внутри которой объявлена переменная. 
        ...
        */
        ...
        var str2; // Эта строка кода всплывёт выше предыдущей и всё будет работать.
        
        /* Объявление и инициализацию можно записать в одну строку. При этом компилятор разделитель
...
console.groupEnd("Приведение простых типов при операциях");        
  ...
  {/* ПРОЦЕДУРНОЕ ПРОГРАММИРОВАНИЕ 
    ...
    */
    ...
    // ЛОКАЛЬНЫЕ ПЕРЕМЕННЫЕ ФУНКЦИИ //
        ...
        str1 = str2 = "Внешнее значение";  // Внешние (глобальные) переменные
        ...
        proc2_call_log(); // "Глобальное значение (в лексическом окружении)"
   ...
   */
    ...
    // ПЕРЕДАЧА ФУНКЦИИ В ПАРАМЕТР ДРУГОЙ ФУНКЦИИ //
        ...
        function callFunc(f) { f(); } // Простейшая функция вызывающая переданную функцию
