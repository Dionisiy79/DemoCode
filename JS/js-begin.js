    ...
    // ОТСУТСТВИЕ ПРОБЛЕМЫ НИСХОДЯЩЕГО ФУНАРГА // 
        ...
        */
        var setfVar = function() { 
            ...
            fVar = subFunc; 
            subFunc = null; /* Для усложнения ситуации удалим подфункцию. Но это ни на что 
                               ...
                               Это благодаря автоматическому управлению памяти в JavaScript */
        }
        
        setfVar();      // Помещаем в fVar ссылку на подфункцию subFunc, а саму подфункцию удаляем
        setfVar = null; /* Очищаем ссылку на родительскую функцию. Но это не удаляет её объект, т.к. 
                           на него продолжает ссылаться [[LexicalEnvironment]] функции fVar */
