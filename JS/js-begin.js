...
"use strict"; /* Эта директива, если стоит первой, переводит интерпретатор в режим повсеместно 
                 поддерживаемого стандарта ES5. При этом теряется совместимость с IE9- и скриптами, 
                 написанными в старых стандартах.  
              ...
              */
{
  {/*  ОБЩИЕ ЛЕКСИЧЕСКИЕ ТЕРМИНЫ И СИНТАКСИЧЕСКИЕ ПРАВИЛА
    ...
    - Если в интрукци символ `;` пропущен, но есть перевод строки, то интерпретатор может его 
  ...
  console.groupCollapsed("Хранение и обработка данных в оперативной памяти");
    ...
    */
    ...
    // ОБЪЯВЛЕНИЕ И ИНИЦИАЛИЗАЦИЯ ПЕРЕМЕННЫХ //
        ...
        /* Новая переменная объявляется с помощью ключевого слова var в любом месте кода.
    ...
    // АВТОМАТИЧЕСКОЕ УПРАВЛЕНИЕ ПАМЯТЬЮ //
        ...
        /* В JavaScript нет чёткого разделения на значимые и ссылочные типы данных. Многое зависит
           ...
           то она станет очищена сборщиком мусора.
