...
Для демонстрации созданных маршрутов создадим blade-шаблон в файле `resources\views\getParams.blade.php`, в котором разными способами создадим активные параметризированные ссылки на эти маршруты.
