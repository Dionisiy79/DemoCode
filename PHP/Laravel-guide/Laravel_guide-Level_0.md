...
После создания файла шаблона его сожержимое можно выдавать в качестве ответа сервера с помощью колбэков `view()`. Для этого создадим в файле маршрутов ещё один маршрут:
...
Скопируем созданный нами файл шаблона в папку `democode\level_0\resources\views` и добавить этот путь в упомянутый выше массив `paths`:
