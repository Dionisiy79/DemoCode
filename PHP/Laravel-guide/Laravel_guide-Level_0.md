...
В blade-шаблонах можно отображать значения строковых переменных либо результатов работы функций, возвращающих строку. Для этого переменную или PHP-код нужно разместить внутри двойных фигурных скобок. Вот пример такого кода:
...
Если же двойные кавычки изнутри дополнить двойными минусами, то получится blade-комментарий, который не будет виден в итоговом HTML-коде. Сравните:
