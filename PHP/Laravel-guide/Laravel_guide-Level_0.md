...
>⇩⇩⇩ Команда консоли в папке laravel-проекта ⇩⇩⇩
...
Колбэк-функцию можно и лучше делать не анонимной, а в виде метода объекта-контроллера. Для этого создатим новый пустой контроллер с именем `SimpleController`. Классически это делается консольной командой:
