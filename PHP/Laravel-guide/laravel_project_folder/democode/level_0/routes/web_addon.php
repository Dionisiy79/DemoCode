...
#------------------------------------#
    ...
    Route::view('/landingpage_1', 'landing1');
...
#-----------------------------------#
    /* Создавая много однотипных страниц неизбежно возникает ситуация, что многих страницы имеют одинаковые блоки. В обычных HTML-документах такие блоки пришлось бы дублировать на всех страницах, а в случае необходимости внести изменения - редактировать такой блок в каждой из страниц. Использование PHP позволяет вставлять содержимое одного файла в другой выражениями типа `require`, благодаря чему можно переиспользуемый код вынести в отдельные файлы, и при необходимости подключать в нужные места. 
    ...
    Допустим, мы решили на всех страницах сайта отображать главное меню. Для этих целей создадим файл menu1.blade.php с парой ссылок. */