...
#############################
    ...
    Теперь, когда файл шаблона создан и в него добавлен какой-то HTML-код, его можно загружать колбэками `view()`. Для этого создадим в файле маршрутов ещё один маршрут:*/
