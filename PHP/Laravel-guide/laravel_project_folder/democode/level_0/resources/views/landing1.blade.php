...
<div>
    ...
    <h3> Отображение значений строк в HTML-коде </h3>
        <p> В blade-шаблонах можно отображать значения строковых и приводимых к строке переменных, а также результаты работы функций, возвращающих строку. Для этого переменную или PHP-код нужно разместить внутри двойных фигурных скобок. Вот пример такого кода: 
