...
<div> <h2> ФУНКЦИОНАЛЬНОЕ ПРОГРАММИРОВАНИЕ </h2>
  ...
  <div>    <h3> *** </h3>
    ...
    ### Возвращение значений и ссылок из функции ###   
		...
		echo "Сумма квадратов 2 и 3 равна: " . summ_sqr(2,3);
        
		// Функция-процедура возвращает null:
			function emptyFunc() {} 
				echo "<br>Пустая функция возвращает " . gettype(emptyFunc()); // NULL
		
		// Функция может возвращать ссылку на значение
	...
	### Вызов функции, имя которой хранится в строковой переменной ###
		...
		// Если после имени переменной указть скобки (), то будет вызвана функция с именем в строке:
