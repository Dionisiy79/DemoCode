...
begin { ЦИКЛЫ }
  ...
  repeat
    i := i div 3;
    write(i,' '); // Можно использовать несколько операторов без заключения их в блок begin-end
...
END. // Коммандой end обозначается конец логического блока. После последнего end ставится точка, а не точка с запятой.
