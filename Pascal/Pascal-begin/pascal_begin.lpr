...
var // Объявление имён изменяемых переменных. Производится до начала раздела операторов.
  ...
  AChar1 : array of char;  // Переменная является указателем на динамический массив символов
...
begin { МНОЖЕСТВА (НАБОРЫ) }
  ...
  { Инициализация и использование множеств }
    ...
    digits_char_set1 := ['0'..'3','5']; // В множестве - несколько символов цифр
  ...
  { Контроль допустимых диаппазонов значений }
    ...
    {$R-} digits_set1 := [7, 12, 300]; // Результат - [7], т.к. 7  - в диаппазоне 0..9
...
begin { ДИНАМИЧЕСКИЕ МАССИВЫ }
  // Инициализация массива должна начинаться с задания его длины
  setLength(AChar1,10);
