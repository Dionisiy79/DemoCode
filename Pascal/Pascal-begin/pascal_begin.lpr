...
begin { ФУНКЦИИ РАБОТЫ СО СТРОКАМИ }
  ...
  { Доступ к строке как к массиву символов. Работает только:
      - с однобайтными кодировками
      - с UTF8-строками с однобайтными символами
    ...
    str2[7]:='R'; // Замена 7-го символа в строке на другой.
        writeln(str2);
  ...
  {$ifdef UTF8mode}
    ...
    // Для всех типов строк можно прочитать один символ как подстроку в строке:
    str2 := UTF8Copy(str1, 5, 1); // Из строки str1 начиная с 5 прочитать 1 символ utf-8
        writeln('5-й символ строки ',str1,' : ',str2);
