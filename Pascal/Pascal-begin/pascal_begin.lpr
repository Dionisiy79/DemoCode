...
const { Объявление имён неизменяемых переменных (констант). Производится
    ...
    {$J-}
    ConstStr1 = 'Привет';  // При {$codepage UTF8} строковый литерал будет сконверирован в UTF-16
...
// Инициализация переменных
  ...
  // Корректность работы разных типов строк со строковыми итералами  зависит от режима компиляции:
