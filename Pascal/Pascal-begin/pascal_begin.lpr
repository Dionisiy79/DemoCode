...
var // Объявление имён изменяемых переменных. Производится до начала раздела операторов.
    ...
    // Ссылку на переменную указанного типа можно объявить, написав перед именем типа оператор ^
...
begin { УКАЗАТЕЛИ И ДИНАМИЧЕСКИЕ ПЕРЕМЕННЫЕ }
  ...
  { БЕЗЫМЯННЫЕ ДИНАМИЧЕСКИЕ ПЕРЕМЕННЫЕ }
